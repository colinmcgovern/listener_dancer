...
OBJ_DEBUG = $(OBJDIR_DEBUG)/texture.o $(OBJDIR_DEBUG)/stb_image.o $(OBJDIR_DEBUG)/shader.o $(OBJDIR_DEBUG)/obj_loader.o $(OBJDIR_DEBUG)/mesh.o $(OBJDIR_DEBUG)/visual.o $(OBJDIR_DEBUG)/main.o $(OBJDIR_DEBUG)/display.o

OBJ_RELEASE = $(OBJDIR_RELEASE)/texture.o $(OBJDIR_RELEASE)/stb_image.o $(OBJDIR_RELEASE)/shader.o $(OBJDIR_RELEASE)/obj_loader.o $(OBJDIR_RELEASE)/mesh.o $(OBJDIR_DEBUG)/visual.o $(OBJDIR_RELEASE)/main.o $(OBJDIR_RELEASE)/display.o
...
$(OBJDIR_DEBUG)/display.o: visual.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c visual.cpp -o $(OBJDIR_DEBUG)/visual.o
